    ...
    <div>
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="relative flex">
          ...
          <div class="hidden w-3/4 bg-gray-100 dark:bg-gray-800 lg:block"></div>

          <div class="container flex flex-col justify-center w-full px-6 py-1 mx-auto lg:absolute lg:inset-x-0">
            <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">
              What our <span class="text-blue-500">Founder's</span> <br />
              saying
            </h1>
            ...
            <div class="mt-10 lg:mt-20 lg:flex lg:items-center">
              ...
              <div class="mt-8 lg:px-10 lg:mt-0">
                ...
                <p class="text-gray-600 dark:text-gray-300">Physiotherapists</p>
              </div>
            </div>
          </div>
        </div>
